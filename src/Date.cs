...
public class Date : global::haxe.lang.HxObject {
	...
	public static global::Date fromNative(global::System.DateTime d) {
		#line 160 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public double getTime() {
		#line 58 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public int getHours() {
		#line 65 "/opt/haxe/std/cs/_std/Date.hx"
		return this.date.Hour;
	}
	#line default
	
	public int getMinutes() {
		#line 69 "/opt/haxe/std/cs/_std/Date.hx"
		return this.date.Minute;
	}
	#line default
	
	public int getSeconds() {
		#line 73 "/opt/haxe/std/cs/_std/Date.hx"
		return this.date.Second;
	}
	#line default
	
	public int getFullYear() {
		#line 77 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public int getMonth() {
		unchecked {
			#line 81 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public int getDate() {
		#line 85 "/opt/haxe/std/cs/_std/Date.hx"
		return this.date.Day;
	}
	#line default
	
	public int getDay() {
		#line 89 "/opt/haxe/std/cs/_std/Date.hx"
		return ((int) (global::haxe.lang.Runtime.toInt(((object) (this.date.DayOfWeek) ))) );
	}
	#line default
	
	public int getUTCHours() {
		#line 93 "/opt/haxe/std/cs/_std/Date.hx"
		return this.dateUTC.Hour;
	}
	#line default
	
	public int getUTCMinutes() {
		#line 97 "/opt/haxe/std/cs/_std/Date.hx"
		return this.dateUTC.Minute;
	}
	#line default
	
	public int getUTCSeconds() {
		#line 101 "/opt/haxe/std/cs/_std/Date.hx"
		return this.dateUTC.Second;
	}
	#line default
	
	public int getUTCFullYear() {
		#line 105 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public int getUTCMonth() {
		unchecked {
			#line 109 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public int getUTCDate() {
		#line 113 "/opt/haxe/std/cs/_std/Date.hx"
		return this.dateUTC.Day;
	}
	#line default
	
	public int getUTCDay() {
		#line 117 "/opt/haxe/std/cs/_std/Date.hx"
		return ((int) (global::haxe.lang.Runtime.toInt(((object) (this.dateUTC.DayOfWeek) ))) );
	}
	#line default
	
	public int getTimezoneOffset() {
		#line 121 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public virtual string toString() {
		#line 125 "/opt/haxe/std/cs/_std/Date.hx"
	...
	public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
		unchecked {
			#line 31 "/opt/haxe/std/cs/_std/Date.hx"
			switch (hash) {
				case 343868310:
				{
					#line 31 "/opt/haxe/std/cs/_std/Date.hx"
