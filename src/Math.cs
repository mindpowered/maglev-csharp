...
public class Math {
	...
	public static int round(double v) {
		unchecked {
			#line 88 "/opt/haxe/std/cs/_std/Math.hx"
			int vint = ((int) (v) );
			double dec = ( v - vint );
			#line 90 "/opt/haxe/std/cs/_std/Math.hx"
			if (( ( dec >= 1 ) || ( dec <= -1 ) )) {
				#line 91 "/opt/haxe/std/cs/_std/Math.hx"
				return vint;
			}
			
			#line 92 "/opt/haxe/std/cs/_std/Math.hx"
			if (( dec >= .5 )) {
				#line 93 "/opt/haxe/std/cs/_std/Math.hx"
				return ( vint + 1 );
			}
			
			#line 94 "/opt/haxe/std/cs/_std/Math.hx"
			if (( dec < -.5 )) {
				#line 95 "/opt/haxe/std/cs/_std/Math.hx"
				return ( vint - 1 );
			}
			
			#line 96 "/opt/haxe/std/cs/_std/Math.hx"
			return vint;
		}
		#line default
	}
	...
	public static bool isNaN(double f) {
		#line 132 "/opt/haxe/std/cs/_std/Math.hx"
		return global::System.Double.IsNaN(((double) (f) ));
	}
	#line default
