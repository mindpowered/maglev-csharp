...
namespace cs.io {
	public class NativeOutput : global::haxe.io.Output {
		...
		public NativeOutput(global::System.IO.Stream stream) {
			#line 34 "/opt/haxe/std/cs/io/NativeOutput.hx"
		...
		public override void writeByte(int c) {
			#line 41 "/opt/haxe/std/cs/io/NativeOutput.hx"
			this.stream.WriteByte(((byte) (c) ));
		}
		#line default
		
		public override void close() {
			#line 45 "/opt/haxe/std/cs/io/NativeOutput.hx"
			this.stream.Close();
		}
		#line default
		
		public override void flush() {
			#line 49 "/opt/haxe/std/cs/io/NativeOutput.hx"
			this.stream.Flush();
		}
		#line default
		
		public override void prepare(int nbytes) {
			#line 54 "/opt/haxe/std/cs/io/NativeOutput.hx"
			this.stream.SetLength(((long) (( ((long) (this.stream.Length) ) + ((long) (nbytes) ) )) ));
		}
		#line default
		
		public bool get_canSeek() {
			#line 58 "/opt/haxe/std/cs/io/NativeOutput.hx"
		...
		public virtual void seek(int p, global::sys.io.FileSeek pos) {
			unchecked {
				#line 62 "/opt/haxe/std/cs/io/NativeOutput.hx"
				...
				#line 68 "/opt/haxe/std/cs/io/NativeOutput.hx"
		...
		public virtual int tell() {
			#line 72 "/opt/haxe/std/cs/io/NativeOutput.hx"
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				#line 29 "/opt/haxe/std/cs/io/NativeOutput.hx"
				switch (hash) {
					case 288167040:
					{
						#line 29 "/opt/haxe/std/cs/io/NativeOutput.hx"
