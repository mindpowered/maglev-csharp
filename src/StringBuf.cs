...
public class StringBuf : global::haxe.lang.HxObject {
	...
	public StringBuf() {
		#line 31 "/opt/haxe/std/cs/_std/StringBuf.hx"
	...
	public virtual void addChar(int c) {
		unchecked {
			#line 49 "/opt/haxe/std/cs/_std/StringBuf.hx"
			if (( c >= 65536 )) {
				#line 50 "/opt/haxe/std/cs/_std/StringBuf.hx"
				this.b.Append(((char) (( (( c >> 10 )) + 55232 )) ));
				this.b.Append(((char) (( (( c & 1023 )) + 56320 )) ));
			}
			else {
				#line 53 "/opt/haxe/std/cs/_std/StringBuf.hx"
	...
	public string toString() {
		#line 58 "/opt/haxe/std/cs/_std/StringBuf.hx"
	...
	public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
		unchecked {
			#line 26 "/opt/haxe/std/cs/_std/StringBuf.hx"
			switch (hash) {
				case 98:
				{
					#line 26 "/opt/haxe/std/cs/_std/StringBuf.hx"
