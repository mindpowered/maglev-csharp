...
public sealed class EReg : global::haxe.lang.HxObject {
	...
	public EReg(string r, string opt) {
		#line 34 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public static string escape(string s) {
		#line 133 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public string matchedRight() {
		#line 74 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public object matchedPos() {
		#line 78 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public string replace(string s, string @by) {
		unchecked {
			#line 105 "/opt/haxe/std/cs/_std/EReg.hx"
			if (this.isGlobal) {
				#line 105 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public string map(string s, global::haxe.lang.Function f) {
		unchecked {
			...
			while (true) {
				...
				#line 120 "/opt/haxe/std/cs/_std/EReg.hx"
				...
				if (( ((int) (global::haxe.lang.Runtime.getField_f(p, "len", 5393365, true)) ) == 0 )) {
					#line 122 "/opt/haxe/std/cs/_std/EReg.hx"
					...
					#line 125 "/opt/haxe/std/cs/_std/EReg.hx"
			...
			#line 127 "/opt/haxe/std/cs/_std/EReg.hx"
			if (( (  ! (this.isGlobal)  && ( offset > 0 ) ) && ( offset < s.Length ) )) {
				#line 128 "/opt/haxe/std/cs/_std/EReg.hx"
				buf_b.Append(((string) (global::Std.@string(global::haxe.lang.StringExt.substr(s, offset, default(global::haxe.lang.Null<int>)))) ));
			}
			
			#line 129 "/opt/haxe/std/cs/_std/EReg.hx"
	...
	public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
		unchecked {
			#line 28 "/opt/haxe/std/cs/_std/EReg.hx"
			switch (hash) {
				case 4949376:
				{
					#line 28 "/opt/haxe/std/cs/_std/EReg.hx"
