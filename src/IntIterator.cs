...
public class IntIterator : global::haxe.lang.HxObject {
	...
	public IntIterator(int min, int max) {
		#line 45 "/opt/haxe/std/IntIterator.hx"
	...
	protected static void __hx_ctor__IntIterator(global::IntIterator __hx_this, int min, int max) {
		#line 46 "/opt/haxe/std/IntIterator.hx"
		__hx_this.min = min;
		__hx_this.max = max;
	}
	#line default
	...
	public bool hasNext() {
		#line 54 "/opt/haxe/std/IntIterator.hx"
		return ( this.min < this.max );
	}
	#line default
	
	public int next() {
		#line 63 "/opt/haxe/std/IntIterator.hx"
		return this.min++;
	}
	#line default
	...
	public override double __hx_setField_f(string field, int hash, double @value, bool handleProperties) {
		unchecked {
			#line 36 "/opt/haxe/std/IntIterator.hx"
			switch (hash) {
				case 5442212:
				{
					#line 36 "/opt/haxe/std/IntIterator.hx"
