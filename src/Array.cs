...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	static Array() {
		...
		unchecked{
			#line 34 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public Array(T[] native) {
		#line 62 "/opt/haxe/std/cs/_std/Array.hx"
		global::Array<object>.__hx_ctor__Array<T>(((global::Array<T>) (this) ), ((T[]) (native) ));
	}
	#line default
	
	public Array() {
		#line 51 "/opt/haxe/std/cs/_std/Array.hx"
	...
	private static void __hx_ctor__Array<T_c>(global::Array<T_c> __hx_this, T_c[] native) {
		#line 63 "/opt/haxe/std/cs/_std/Array.hx"
	...
	private static void __hx_ctor__Array<T_c>(global::Array<T_c> __hx_this) {
		#line 52 "/opt/haxe/std/cs/_std/Array.hx"
		__hx_this.length = 0;
	...
	public static object __hx_cast<T_c_c>(global::Array me) {
		#line 29 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public global::Array<T> concat(global::Array<T> a) {
		#line 69 "/opt/haxe/std/cs/_std/Array.hx"
		int len = ( this.length + a.length );
		T[] retarr = new T[len];
		#line 71 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public void concatNative(T[] a) {
		...
		if (( ( __a as global::System.Array ).Length >= len )) {
			...
			#line 87 "/opt/haxe/std/cs/_std/Array.hx"
			this.__a = newarr;
		}
		
		#line 90 "/opt/haxe/std/cs/_std/Array.hx"
		this.length = len;
	}
	#line default
	...
	public int indexOf(T x, global::haxe.lang.Null<int> fromIndex) {
		unchecked {
			#line 94 "/opt/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			#line 94 "/opt/haxe/std/cs/_std/Array.hx"
			int i = ( ( ! (fromIndex.hasValue) ) ? (0) : ((fromIndex).@value) );
			if (( i < 0 )) {
				#line 96 "/opt/haxe/std/cs/_std/Array.hx"
				i += len;
				if (( i < 0 )) {
					#line 98 "/opt/haxe/std/cs/_std/Array.hx"
					i = 0;
				}
				
			}
			else if (( i >= len )) {
				#line 100 "/opt/haxe/std/cs/_std/Array.hx"
				return -1;
			}
			
			#line 102 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public int lastIndexOf(T x, global::haxe.lang.Null<int> fromIndex) {
		unchecked {
			#line 106 "/opt/haxe/std/cs/_std/Array.hx"
			int len = this.length;
			#line 106 "/opt/haxe/std/cs/_std/Array.hx"
			int i = ( ( ! (fromIndex.hasValue) ) ? (( len - 1 )) : ((fromIndex).@value) );
			if (( i >= len )) {
				#line 108 "/opt/haxe/std/cs/_std/Array.hx"
				i = ( len - 1 );
			}
			else if (( i < 0 )) {
				#line 110 "/opt/haxe/std/cs/_std/Array.hx"
				i += len;
				if (( i < 0 )) {
					#line 112 "/opt/haxe/std/cs/_std/Array.hx"
					return -1;
				}
				
			}
			
			#line 114 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public string @join(string sep) {
		unchecked {
			#line 118 "/opt/haxe/std/cs/_std/Array.hx"
			global::System.Text.StringBuilder buf_b = new global::System.Text.StringBuilder();
			int i = -1;
			#line 121 "/opt/haxe/std/cs/_std/Array.hx"
			bool first = true;
			int length = this.length;
			#line 123 "/opt/haxe/std/cs/_std/Array.hx"
			while ((  ++ i < length )) {
				#line 124 "/opt/haxe/std/cs/_std/Array.hx"
				if (first) {
					#line 125 "/opt/haxe/std/cs/_std/Array.hx"
					first = false;
				}
				else {
					#line 127 "/opt/haxe/std/cs/_std/Array.hx"
					buf_b.Append(((string) (global::Std.@string(sep)) ));
				}
				
				#line 128 "/opt/haxe/std/cs/_std/Array.hx"
				buf_b.Append(((string) (global::Std.@string(global::haxe.lang.Runtime.genericCast<T>(this.__a[i]))) ));
			}
			
			#line 131 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public global::haxe.lang.Null<T> pop() {
		#line 135 "/opt/haxe/std/cs/_std/Array.hx"
		T[] __a = this.__a;
		int length = this.length;
		#line 137 "/opt/haxe/std/cs/_std/Array.hx"
		if (( length > 0 )) {
			#line 138 "/opt/haxe/std/cs/_std/Array.hx"
			T val = global::haxe.lang.Runtime.genericCast<T>(__a[ -- length]);
			__a[length] = default(T);
			#line 140 "/opt/haxe/std/cs/_std/Array.hx"
			this.length = length;
			#line 142 "/opt/haxe/std/cs/_std/Array.hx"
			return new global::haxe.lang.Null<T>(val, true);
		}
		else {
			#line 144 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public int push(T x) {
		unchecked {
			#line 149 "/opt/haxe/std/cs/_std/Array.hx"
			if (( this.length >= ( this.__a as global::System.Array ).Length )) {
				#line 150 "/opt/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( this.length == 0 )) ? (4) : (( this.length << 1 )) );
				T[] newarr = new T[newLen];
				#line 152 "/opt/haxe/std/cs/_std/Array.hx"
				( this.__a as global::System.Array ).CopyTo(((global::System.Array) (newarr) ), ((int) (0) ));
				#line 154 "/opt/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
			}
			
			#line 157 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public void reverse() {
		unchecked {
			#line 162 "/opt/haxe/std/cs/_std/Array.hx"
			int i = 0;
			int l = this.length;
			#line 164 "/opt/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			int half = ( l >> 1 );
			#line 166 "/opt/haxe/std/cs/_std/Array.hx"
			 -- l;
			while (( i < half )) {
				#line 168 "/opt/haxe/std/cs/_std/Array.hx"
				T tmp = global::haxe.lang.Runtime.genericCast<T>(a[i]);
				a[i] = global::haxe.lang.Runtime.genericCast<T>(a[( l - i )]);
				#line 170 "/opt/haxe/std/cs/_std/Array.hx"
				a[( l - i )] = tmp;
				 ++ i;
			}
	...
	public global::haxe.lang.Null<T> shift() {
		unchecked {
			#line 176 "/opt/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( l == 0 )) {
				#line 178 "/opt/haxe/std/cs/_std/Array.hx"
				return default(global::haxe.lang.Null<T>);
			}
			
			#line 180 "/opt/haxe/std/cs/_std/Array.hx"
			T[] a = this.__a;
			T x = global::haxe.lang.Runtime.genericCast<T>(a[0]);
			#line 182 "/opt/haxe/std/cs/_std/Array.hx"
			 -- l;
			global::System.Array.Copy(((global::System.Array) (a) ), ((int) (1) ), ((global::System.Array) (a) ), ((int) (0) ), ((int) (( this.length - 1 )) ));
			#line 184 "/opt/haxe/std/cs/_std/Array.hx"
			a[l] = default(T);
			this.length = l;
			#line 187 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public global::Array<T> slice(int pos, global::haxe.lang.Null<int> end) {
		#line 191 "/opt/haxe/std/cs/_std/Array.hx"
		if (( pos < 0 )) {
			#line 192 "/opt/haxe/std/cs/_std/Array.hx"
			pos = ( this.length + pos );
			if (( pos < 0 )) {
				#line 194 "/opt/haxe/std/cs/_std/Array.hx"
				pos = 0;
			}
			
		}
		
		#line 196 "/opt/haxe/std/cs/_std/Array.hx"
		if ( ! (end.hasValue) ) {
			#line 197 "/opt/haxe/std/cs/_std/Array.hx"
			end = new global::haxe.lang.Null<int>(this.length, true);
		}
		else if (( (end).@value < 0 )) {
			#line 199 "/opt/haxe/std/cs/_std/Array.hx"
			end = new global::haxe.lang.Null<int>(( this.length + (end).@value ), true);
		}
		
		#line 200 "/opt/haxe/std/cs/_std/Array.hx"
		if (( (end).@value > this.length )) {
			#line 201 "/opt/haxe/std/cs/_std/Array.hx"
			end = new global::haxe.lang.Null<int>(this.length, true);
		}
		
		#line 202 "/opt/haxe/std/cs/_std/Array.hx"
		int len = ( (end).@value - pos );
		if (( len < 0 )) {
			#line 204 "/opt/haxe/std/cs/_std/Array.hx"
			return new global::Array<T>();
		}
		
		#line 206 "/opt/haxe/std/cs/_std/Array.hx"
		T[] newarr = new T[len];
		global::System.Array.Copy(((global::System.Array) (this.__a) ), ((int) (pos) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (len) ));
		#line 209 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public void sort(global::haxe.lang.Function f) {
		unchecked {
			#line 213 "/opt/haxe/std/cs/_std/Array.hx"
			if (( this.length == 0 )) {
				#line 214 "/opt/haxe/std/cs/_std/Array.hx"
				return;
			}
			
			#line 215 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public void quicksort(int lo, int hi, global::haxe.lang.Function f) {
		unchecked {
			#line 219 "/opt/haxe/std/cs/_std/Array.hx"
			T[] buf = this.__a;
			int i = lo;
			int j = hi;
			#line 221 "/opt/haxe/std/cs/_std/Array.hx"
			T p = global::haxe.lang.Runtime.genericCast<T>(buf[( ( i + j ) >> 1 )]);
			while (( i <= j )) {
				#line 223 "/opt/haxe/std/cs/_std/Array.hx"
				while (( ( i < hi ) && ( ((int) (f.__hx_invoke2_f(default(double), global::haxe.lang.Runtime.genericCast<T>(buf[i]), default(double), p)) ) < 0 ) )) {
					#line 224 "/opt/haxe/std/cs/_std/Array.hx"
					 ++ i;
				}
				
				#line 225 "/opt/haxe/std/cs/_std/Array.hx"
				while (( ( j > lo ) && ( ((int) (f.__hx_invoke2_f(default(double), global::haxe.lang.Runtime.genericCast<T>(buf[j]), default(double), p)) ) > 0 ) )) {
					#line 226 "/opt/haxe/std/cs/_std/Array.hx"
					 -- j;
				}
				
				#line 227 "/opt/haxe/std/cs/_std/Array.hx"
				if (( i <= j )) {
					#line 228 "/opt/haxe/std/cs/_std/Array.hx"
					T t = global::haxe.lang.Runtime.genericCast<T>(buf[i]);
					buf[i++] = global::haxe.lang.Runtime.genericCast<T>(buf[j]);
					#line 230 "/opt/haxe/std/cs/_std/Array.hx"
					buf[j--] = t;
				}
				
			}
			
			#line 234 "/opt/haxe/std/cs/_std/Array.hx"
			if (( lo < j )) {
				#line 235 "/opt/haxe/std/cs/_std/Array.hx"
				this.quicksort(lo, j, f);
			}
			
			#line 236 "/opt/haxe/std/cs/_std/Array.hx"
			if (( i < hi )) {
				#line 237 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public global::Array<T> splice(int pos, int len) {
		#line 241 "/opt/haxe/std/cs/_std/Array.hx"
		if (( len < 0 )) {
			#line 242 "/opt/haxe/std/cs/_std/Array.hx"
			return new global::Array<T>();
		}
		
		#line 243 "/opt/haxe/std/cs/_std/Array.hx"
		if (( pos < 0 )) {
			#line 244 "/opt/haxe/std/cs/_std/Array.hx"
			pos = ( this.length + pos );
			if (( pos < 0 )) {
				#line 246 "/opt/haxe/std/cs/_std/Array.hx"
				pos = 0;
			}
			
		}
		
		#line 248 "/opt/haxe/std/cs/_std/Array.hx"
		if (( pos > this.length )) {
			#line 249 "/opt/haxe/std/cs/_std/Array.hx"
			pos = 0;
			len = 0;
		}
		else if (( ( pos + len ) > this.length )) {
			#line 252 "/opt/haxe/std/cs/_std/Array.hx"
			len = ( this.length - pos );
			if (( len < 0 )) {
				#line 254 "/opt/haxe/std/cs/_std/Array.hx"
				len = 0;
			}
			
		}
		
		#line 256 "/opt/haxe/std/cs/_std/Array.hx"
		T[] a = this.__a;
		#line 258 "/opt/haxe/std/cs/_std/Array.hx"
		T[] ret = new T[len];
		global::System.Array.Copy(((global::System.Array) (a) ), ((int) (pos) ), ((global::System.Array) (ret) ), ((int) (0) ), ((int) (len) ));
		#line 260 "/opt/haxe/std/cs/_std/Array.hx"
		global::Array<T> ret1 = new global::Array<T>(((T[]) (ret) ));
		#line 262 "/opt/haxe/std/cs/_std/Array.hx"
		int end = ( pos + len );
		global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
		#line 264 "/opt/haxe/std/cs/_std/Array.hx"
		this.length -= len;
		while ((  -- len >= 0 )) {
			#line 266 "/opt/haxe/std/cs/_std/Array.hx"
			a[( this.length + len )] = default(T);
		}
		
		#line 267 "/opt/haxe/std/cs/_std/Array.hx"
		return ret1;
	}
	#line default
	
	public void spliceVoid(int pos, int len) {
		#line 271 "/opt/haxe/std/cs/_std/Array.hx"
		if (( len < 0 )) {
			#line 272 "/opt/haxe/std/cs/_std/Array.hx"
			return;
		}
		
		#line 273 "/opt/haxe/std/cs/_std/Array.hx"
		if (( pos < 0 )) {
			#line 274 "/opt/haxe/std/cs/_std/Array.hx"
			pos = ( this.length + pos );
			if (( pos < 0 )) {
				#line 276 "/opt/haxe/std/cs/_std/Array.hx"
				pos = 0;
			}
			
		}
		
		#line 278 "/opt/haxe/std/cs/_std/Array.hx"
		if (( pos > this.length )) {
			#line 279 "/opt/haxe/std/cs/_std/Array.hx"
			pos = 0;
			len = 0;
		}
		else if (( ( pos + len ) > this.length )) {
			#line 282 "/opt/haxe/std/cs/_std/Array.hx"
			len = ( this.length - pos );
			if (( len < 0 )) {
				#line 284 "/opt/haxe/std/cs/_std/Array.hx"
				len = 0;
			}
			
		}
		
		#line 286 "/opt/haxe/std/cs/_std/Array.hx"
		T[] a = this.__a;
		#line 288 "/opt/haxe/std/cs/_std/Array.hx"
		int end = ( pos + len );
		global::System.Array.Copy(((global::System.Array) (a) ), ((int) (end) ), ((global::System.Array) (a) ), ((int) (pos) ), ((int) (( this.length - end )) ));
		#line 290 "/opt/haxe/std/cs/_std/Array.hx"
		this.length -= len;
		while ((  -- len >= 0 )) {
			#line 292 "/opt/haxe/std/cs/_std/Array.hx"
			a[( this.length + len )] = default(T);
		}
	...
	public string toString() {
		unchecked {
			#line 296 "/opt/haxe/std/cs/_std/Array.hx"
			if (( global::Array<object>.__hx_toString_depth >= 5 )) {
				#line 297 "/opt/haxe/std/cs/_std/Array.hx"
				return "...";
			}
			
			#line 299 "/opt/haxe/std/cs/_std/Array.hx"
			 ++ global::Array<object>.__hx_toString_depth;
			try {
				#line 301 "/opt/haxe/std/cs/_std/Array.hx"
				string s = this.__hx_toString();
				 -- global::Array<object>.__hx_toString_depth;
				#line 303 "/opt/haxe/std/cs/_std/Array.hx"
				return s;
			}
				...
				#line 305 "/opt/haxe/std/cs/_std/Array.hx"
				 -- global::Array<object>.__hx_toString_depth;
	...
	public string __hx_toString() {
		#line 312 "/opt/haxe/std/cs/_std/Array.hx"
		global::System.Text.StringBuilder ret_b = new global::System.Text.StringBuilder();
		T[] a = this.__a;
		#line 314 "/opt/haxe/std/cs/_std/Array.hx"
		ret_b.Append(((string) ("[") ));
		bool first = true;
		#line 316 "/opt/haxe/std/cs/_std/Array.hx"
		{
			#line 316 "/opt/haxe/std/cs/_std/Array.hx"
			int _g = 0;
			#line 316 "/opt/haxe/std/cs/_std/Array.hx"
			...
			while (( _g < _g1 )) {
				...
				int i = _g++;
				if (first) {
					#line 318 "/opt/haxe/std/cs/_std/Array.hx"
					first = false;
				}
				else {
					#line 320 "/opt/haxe/std/cs/_std/Array.hx"
					ret_b.Append(((string) (",") ));
				}
				
				#line 321 "/opt/haxe/std/cs/_std/Array.hx"
				ret_b.Append(((string) (global::Std.@string(global::haxe.lang.Runtime.genericCast<T>(a[i]))) ));
			}
			
		}
		
		#line 324 "/opt/haxe/std/cs/_std/Array.hx"
		ret_b.Append(((string) ("]") ));
	...
	public void unshift(T x) {
		unchecked {
			#line 329 "/opt/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int length = this.length;
			#line 331 "/opt/haxe/std/cs/_std/Array.hx"
			if (( length >= ( __a as global::System.Array ).Length )) {
				#line 332 "/opt/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( length << 1 )) + 1 );
				T[] newarr = new T[newLen];
				#line 334 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Copy(((global::System.Array) (__a) ), ((int) (0) ), ((global::System.Array) (newarr) ), ((int) (1) ), ((int) (length) ));
				#line 336 "/opt/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
			}
			else {
				#line 338 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Copy(((global::System.Array) (__a) ), ((int) (0) ), ((global::System.Array) (__a) ), ((int) (1) ), ((int) (length) ));
			}
			
			#line 341 "/opt/haxe/std/cs/_std/Array.hx"
			this.__a[0] = x;
			 ++ this.length;
		}
		#line default
	...
	public void insert(int pos, T x) {
		unchecked {
			#line 346 "/opt/haxe/std/cs/_std/Array.hx"
			int l = this.length;
			if (( pos < 0 )) {
				#line 348 "/opt/haxe/std/cs/_std/Array.hx"
				pos = ( l + pos );
				if (( pos < 0 )) {
					#line 350 "/opt/haxe/std/cs/_std/Array.hx"
					pos = 0;
				}
				
			}
			
			#line 352 "/opt/haxe/std/cs/_std/Array.hx"
			if (( pos >= l )) {
				#line 353 "/opt/haxe/std/cs/_std/Array.hx"
				this.push(x);
				return;
			}
			else if (( pos == 0 )) {
				#line 356 "/opt/haxe/std/cs/_std/Array.hx"
				this.unshift(x);
				return;
			}
			
			#line 360 "/opt/haxe/std/cs/_std/Array.hx"
			if (( l >= ( this.__a as global::System.Array ).Length )) {
				#line 361 "/opt/haxe/std/cs/_std/Array.hx"
				int newLen = ( (( this.length << 1 )) + 1 );
				T[] newarr = new T[newLen];
				#line 363 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Copy(((global::System.Array) (this.__a) ), ((int) (0) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (pos) ));
				newarr[pos] = x;
				#line 365 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Copy(((global::System.Array) (this.__a) ), ((int) (pos) ), ((global::System.Array) (newarr) ), ((int) (( pos + 1 )) ), ((int) (( l - pos )) ));
				#line 367 "/opt/haxe/std/cs/_std/Array.hx"
				this.__a = newarr;
				 ++ this.length;
			}
			else {
				#line 370 "/opt/haxe/std/cs/_std/Array.hx"
				T[] __a = this.__a;
				global::System.Array.Copy(((global::System.Array) (__a) ), ((int) (pos) ), ((global::System.Array) (__a) ), ((int) (( pos + 1 )) ), ((int) (( l - pos )) ));
				#line 372 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Copy(((global::System.Array) (__a) ), ((int) (0) ), ((global::System.Array) (__a) ), ((int) (0) ), ((int) (pos) ));
				__a[pos] = x;
				#line 374 "/opt/haxe/std/cs/_std/Array.hx"
				 ++ this.length;
			}
	...
	public bool @remove(T x) {
		unchecked {
			#line 379 "/opt/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int i = -1;
			#line 381 "/opt/haxe/std/cs/_std/Array.hx"
			int length = this.length;
			while ((  ++ i < length )) {
				#line 383 "/opt/haxe/std/cs/_std/Array.hx"
				if (global::haxe.lang.Runtime.eq(global::haxe.lang.Runtime.genericCast<T>(__a[i]), x)) {
					#line 384 "/opt/haxe/std/cs/_std/Array.hx"
					...
					#line 387 "/opt/haxe/std/cs/_std/Array.hx"
					return true;
				}
				
			}
			
			#line 391 "/opt/haxe/std/cs/_std/Array.hx"
			return false;
		}
		#line default
	}
	...
	public global::Array<S> map<S>(global::haxe.lang.Function f) {
		#line 395 "/opt/haxe/std/cs/_std/Array.hx"
		global::Array<S> ret = new global::Array<S>(((S[]) (new S[this.length]) ));
		{
			#line 396 "/opt/haxe/std/cs/_std/Array.hx"
			int _g = 0;
			#line 396 "/opt/haxe/std/cs/_std/Array.hx"
			int _g1 = this.length;
			#line 396 "/opt/haxe/std/cs/_std/Array.hx"
			while (( _g < _g1 )) {
				...
				int i = _g++;
				{
					#line 397 "/opt/haxe/std/cs/_std/Array.hx"
		...
		#line 398 "/opt/haxe/std/cs/_std/Array.hx"
		return ret;
	}
	#line default
	...
	public bool contains(T x) {
		unchecked {
			#line 402 "/opt/haxe/std/cs/_std/Array.hx"
			T[] __a = this.__a;
			int i = -1;
			#line 404 "/opt/haxe/std/cs/_std/Array.hx"
			int length = this.length;
			while ((  ++ i < length )) {
				#line 406 "/opt/haxe/std/cs/_std/Array.hx"
				if (global::haxe.lang.Runtime.eq(global::haxe.lang.Runtime.genericCast<T>(__a[i]), x)) {
					#line 407 "/opt/haxe/std/cs/_std/Array.hx"
					return true;
				}
				
			}
			
			#line 409 "/opt/haxe/std/cs/_std/Array.hx"
			return false;
		}
		#line default
	}
	...
	public global::Array<T> filter(global::haxe.lang.Function f) {
		#line 413 "/opt/haxe/std/cs/_std/Array.hx"
		global::Array<T> ret = new global::Array<T>(new T[]{});
		{
			#line 414 "/opt/haxe/std/cs/_std/Array.hx"
			int _g = 0;
			#line 414 "/opt/haxe/std/cs/_std/Array.hx"
			int _g1 = this.length;
			#line 414 "/opt/haxe/std/cs/_std/Array.hx"
			while (( _g < _g1 )) {
				...
				#line 416 "/opt/haxe/std/cs/_std/Array.hx"
				if (global::haxe.lang.Runtime.toBool(f.__hx_invoke1_o(default(double), elt))) {
					#line 417 "/opt/haxe/std/cs/_std/Array.hx"
					ret.push(elt);
				}
		...
		#line 419 "/opt/haxe/std/cs/_std/Array.hx"
		return ret;
	}
	#line default
	
	public global::Array<T> copy() {
		#line 423 "/opt/haxe/std/cs/_std/Array.hx"
		int len = this.length;
		T[] __a = this.__a;
		#line 425 "/opt/haxe/std/cs/_std/Array.hx"
		T[] newarr = new T[len];
		global::System.Array.Copy(((global::System.Array) (__a) ), ((int) (0) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (len) ));
		#line 427 "/opt/haxe/std/cs/_std/Array.hx"
		return new global::Array<T>(((T[]) (newarr) ));
	}
	#line default
	
	public global::haxe.iterators.ArrayIterator<T> iterator() {
		#line 431 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public global::haxe.iterators.ArrayKeyValueIterator<T> keyValueIterator() {
		#line 436 "/opt/haxe/std/cs/_std/Array.hx"
		return new global::haxe.iterators.ArrayKeyValueIterator<T>(((global::Array<T>) (this) ));
	}
	#line default
	
	public void resize(int len) {
		#line 440 "/opt/haxe/std/cs/_std/Array.hx"
		if (( this.length < len )) {
			#line 441 "/opt/haxe/std/cs/_std/Array.hx"
			if (( ( this.__a as global::System.Array ).Length < len )) {
				#line 442 "/opt/haxe/std/cs/_std/Array.hx"
				global::System.Array.Resize<T>(ref this.__a, ((int) (len) ));
			}
			
			#line 444 "/opt/haxe/std/cs/_std/Array.hx"
			this.length = len;
		}
		else if (( this.length > len )) {
			#line 446 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public T __get(int idx) {
		#line 451 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public T __set(int idx, T v) {
		unchecked {
			#line 455 "/opt/haxe/std/cs/_std/Array.hx"
			uint idx1 = ((uint) (idx) );
			T[] __a = this.__a;
			#line 457 "/opt/haxe/std/cs/_std/Array.hx"
			if (( idx1 >= ( __a as global::System.Array ).Length )) {
				#line 458 "/opt/haxe/std/cs/_std/Array.hx"
				uint len = ((uint) (( idx1 + 1 )) );
				if (( idx1 == ( __a as global::System.Array ).Length )) {
					#line 460 "/opt/haxe/std/cs/_std/Array.hx"
					len = ((uint) (( (( idx1 << 1 )) + 1 )) );
				}
				
				#line 461 "/opt/haxe/std/cs/_std/Array.hx"
				T[] newArr = new T[((int) (len) )];
				( __a as global::System.Array ).CopyTo(((global::System.Array) (newArr) ), ((int) (0) ));
				#line 463 "/opt/haxe/std/cs/_std/Array.hx"
				__a = newArr;
				#line 463 "/opt/haxe/std/cs/_std/Array.hx"
				this.__a = __a;
			}
			
			#line 466 "/opt/haxe/std/cs/_std/Array.hx"
			if (( idx1 >= this.length )) {
				#line 467 "/opt/haxe/std/cs/_std/Array.hx"
				this.length = ((int) (((uint) (( idx1 + 1 )) )) );
			}
			
			#line 469 "/opt/haxe/std/cs/_std/Array.hx"
	...
	public T __unsafe_get(int idx) {
		#line 473 "/opt/haxe/std/cs/_std/Array.hx"
		return global::haxe.lang.Runtime.genericCast<T>(this.__a[idx]);
	}
	#line default
	
	public T __unsafe_set(int idx, T val) {
		#line 477 "/opt/haxe/std/cs/_std/Array.hx"
