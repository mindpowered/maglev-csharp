...
namespace haxe {
	public class Log : global::haxe.lang.HxObject {
		...
		static Log() {
			#line 62 "/opt/haxe/std/haxe/Log.hx"
		...
		public Log() {
			#line 29 "/opt/haxe/std/haxe/Log.hx"
		...
		public static string formatOutput(object v, object infos) {
			#line 34 "/opt/haxe/std/haxe/Log.hx"
			string str = global::Std.@string(v);
			if (( infos == null )) {
				#line 36 "/opt/haxe/std/haxe/Log.hx"
				return str;
			}
			
			#line 37 "/opt/haxe/std/haxe/Log.hx"
			...
			if (( ((global::Array) (global::haxe.lang.Runtime.getField(infos, "customParams", 1830310359, true)) ) != null )) {
				#line 39 "/opt/haxe/std/haxe/Log.hx"
				int _g = 0;
				#line 39 "/opt/haxe/std/haxe/Log.hx"
			...
			#line 41 "/opt/haxe/std/haxe/Log.hx"
...
namespace haxe {
	public class Log_Anon_62__Fun : global::haxe.lang.Function {
		...
		public override object __hx_invoke2_o(double __fn_float1, object __fn_dyn1, double __fn_float2, object __fn_dyn2) {
			...
			#line 70 "/opt/haxe/std/haxe/Log.hx"
