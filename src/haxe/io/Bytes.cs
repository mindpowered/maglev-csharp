...
namespace haxe.io {
	public class Bytes : global::haxe.lang.HxObject {
		...
		public Bytes(int length, byte[] b) {
			#line 34 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		protected static void __hx_ctor_haxe_io_Bytes(global::haxe.io.Bytes __hx_this, int length, byte[] b) {
			#line 35 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public static global::haxe.io.Bytes alloc(int length) {
			#line 562 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public static global::haxe.io.Bytes ofData(byte[] b) {
			#line 662 "/opt/haxe/std/haxe/io/Bytes.hx"
			return new global::haxe.io.Bytes(( b as global::System.Array ).Length, b);
		}
		#line default
			...
			unchecked {
				...
				global::haxe.io.Bytes ret = global::haxe.io.Bytes.alloc(( len >> 1 ));
				{
					...
					while (( _g < _g1 )) {
						...
						#line 680 "/opt/haxe/std/haxe/io/Bytes.hx"
						int index1 = ( ( i * 2 ) + 1 );
						#line 680 "/opt/haxe/std/haxe/io/Bytes.hx"
						int low = ( (( ((uint) (index1) ) < s.Length )) ? (((int) (s[index1]) )) : (-1) );
						high = ( (( high & 15 )) + ( (( (( high & 64 )) >> 6 )) * 9 ) );
						#line 682 "/opt/haxe/std/haxe/io/Bytes.hx"
				...
				#line 686 "/opt/haxe/std/haxe/io/Bytes.hx"
				return ret;
			}
			#line default
		}
		...
		public static int fastGet(byte[] b, int pos) {
			#line 704 "/opt/haxe/std/haxe/io/Bytes.hx"
			return ((int) (b[pos]) );
		}
		#line default
		...
		public virtual void fill(int pos, int len, int @value) {
			#line 146 "/opt/haxe/std/haxe/io/Bytes.hx"
			int _g = 0;
			#line 146 "/opt/haxe/std/haxe/io/Bytes.hx"
			int _g1 = len;
			#line 146 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public virtual global::haxe.io.Bytes sub(int pos, int len) {
			#line 157 "/opt/haxe/std/haxe/io/Bytes.hx"
			if (( ( ( pos < 0 ) || ( len < 0 ) ) || ( ( pos + len ) > this.length ) )) {
				#line 158 "/opt/haxe/std/haxe/io/Bytes.hx"
				throw ((global::System.Exception) (global::haxe.Exception.thrown(global::haxe.io.Error.OutsideBounds)) );
			}
			
			#line 172 "/opt/haxe/std/haxe/io/Bytes.hx"
			byte[] newarr = new byte[len];
			global::System.Array.Copy(((global::System.Array) (this.b) ), ((int) (pos) ), ((global::System.Array) (newarr) ), ((int) (0) ), ((int) (len) ));
			#line 174 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public virtual double getDouble(int pos) {
			unchecked {
				#line 257 "/opt/haxe/std/haxe/io/Bytes.hx"
				int pos1 = ( pos + 4 );
				#line 257 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public virtual double getFloat(int pos) {
			unchecked {
				#line 280 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public virtual void setDouble(int pos, double v) {
			unchecked {
				#line 305 "/opt/haxe/std/haxe/io/Bytes.hx"
				long i = global::haxe.io.FPHelper.doubleToI64(v);
				{
					#line 306 "/opt/haxe/std/haxe/io/Bytes.hx"
					int v1 = ((int) (((long) (i) )) );
					#line 306 "/opt/haxe/std/haxe/io/Bytes.hx"
					this.b[pos] = ((byte) (v1) );
					#line 306 "/opt/haxe/std/haxe/io/Bytes.hx"
				...
				#line 307 "/opt/haxe/std/haxe/io/Bytes.hx"
				{
					#line 307 "/opt/haxe/std/haxe/io/Bytes.hx"
					int pos1 = ( pos + 4 );
					#line 307 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public virtual void setFloat(int pos, double v) {
			unchecked {
				#line 332 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public int getUInt16(int pos) {
			unchecked {
				#line 344 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public void setUInt16(int pos, int v) {
			unchecked {
				#line 356 "/opt/haxe/std/haxe/io/Bytes.hx"
				this.b[pos] = ((byte) (v) );
		...
		public int getInt32(int pos) {
			unchecked {
				#line 375 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public long getInt64(int pos) {
			unchecked {
				#line 384 "/opt/haxe/std/haxe/io/Bytes.hx"
				int pos1 = ( pos + 4 );
				#line 384 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public void setInt32(int pos, int v) {
			unchecked {
				#line 395 "/opt/haxe/std/haxe/io/Bytes.hx"
				this.b[pos] = ((byte) (v) );
				this.b[( pos + 1 )] = ((byte) (( v >> 8 )) );
				#line 397 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public void setInt64(int pos, long v) {
			unchecked {
				#line 407 "/opt/haxe/std/haxe/io/Bytes.hx"
				{
					#line 407 "/opt/haxe/std/haxe/io/Bytes.hx"
					int v1 = ((int) (((long) (v) )) );
					#line 407 "/opt/haxe/std/haxe/io/Bytes.hx"
				...
				#line 408 "/opt/haxe/std/haxe/io/Bytes.hx"
				{
					#line 408 "/opt/haxe/std/haxe/io/Bytes.hx"
					int pos1 = ( pos + 4 );
					#line 408 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public string readString(int pos, int len) {
			#line 496 "/opt/haxe/std/haxe/io/Bytes.hx"
			return this.getString(pos, len, null);
		}
		#line default
		
		public virtual string toString() {
			#line 509 "/opt/haxe/std/haxe/io/Bytes.hx"
		...
		public byte[] getData() {
			#line 542 "/opt/haxe/std/haxe/io/Bytes.hx"
			return this.b;
		}
		#line default
		...
		public override double __hx_setField_f(string field, int hash, double @value, bool handleProperties) {
			unchecked {
				#line 29 "/opt/haxe/std/haxe/io/Bytes.hx"
				switch (hash) {
					case 520590566:
					{
						#line 29 "/opt/haxe/std/haxe/io/Bytes.hx"
