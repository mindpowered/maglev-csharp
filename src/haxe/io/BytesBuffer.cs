...
namespace haxe.io {
	public class BytesBuffer : global::haxe.lang.HxObject {
		...
		public BytesBuffer() {
			#line 45 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
		...
		public int get_length() {
			unchecked {
				#line 68 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
		...
		public virtual void addInt64(long v) {
			unchecked {
				#line 145 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
		...
		public virtual global::haxe.io.Bytes getBytes() {
			...
			#line 222 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
			this.b = null;
			return bytes;
		}
		#line default
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				#line 25 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
				switch (hash) {
					case 98:
					{
						#line 25 "/opt/haxe/std/haxe/io/BytesBuffer.hx"
