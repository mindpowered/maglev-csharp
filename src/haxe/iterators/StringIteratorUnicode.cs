...
namespace haxe.iterators {
	public class StringIteratorUnicode : global::haxe.lang.HxObject {
		...
		public StringIteratorUnicode(string s) {
			#line 40 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
		...
		protected static void __hx_ctor_haxe_iterators_StringIteratorUnicode(global::haxe.iterators.StringIteratorUnicode __hx_this, string s) {
			#line 34 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
			__hx_this.offset = 0;
			#line 41 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
			{
				#line 41 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
				__hx_this.s = s;
			}
		...
		public static global::haxe.iterators.StringIteratorUnicode unicodeIterator(string s) {
			#line 71 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
		...
		public bool hasNext() {
			#line 48 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
		...
		public int next() {
			unchecked {
				#line 57 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
				string s = this.s;
				#line 57 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
				...
				int c1 = c;
				if (( c1 >= 65536 )) {
					#line 59 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
					this.offset++;
				}
				
				#line 61 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
				return c1;
			}
			#line default
		}
		...
		public override double __hx_setField_f(string field, int hash, double @value, bool handleProperties) {
			unchecked {
				#line 33 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
				switch (hash) {
					case 1614780307:
					{
						#line 33 "/opt/haxe/std/haxe/iterators/StringIteratorUnicode.hx"
