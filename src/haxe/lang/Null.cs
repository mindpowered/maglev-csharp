...
namespace haxe.lang {
	public struct Null<T> {
		...
		public Null(T v, bool hasValue) {
			#line 63 "/opt/haxe/std/cs/internal/Null.hx"
			if (( hasValue && global::System.Object.ReferenceEquals(((object) (v) ), default(object)) )) {
				#line 64 "/opt/haxe/std/cs/internal/Null.hx"
				hasValue = false;
			}
			
			#line 66 "/opt/haxe/std/cs/internal/Null.hx"
			this.@value = v;
		...
		public object toDynamic() {
			#line 84 "/opt/haxe/std/cs/internal/Null.hx"
			if (this.hasValue) {
				#line 85 "/opt/haxe/std/cs/internal/Null.hx"
				return this.@value;
			}
			
			#line 86 "/opt/haxe/std/cs/internal/Null.hx"
			return null;
		}
		#line default
